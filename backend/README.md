...
## Project Structure
    ...
    ├── polished_feather_de_92723  # Django project configurations
...
1. Clone this repo and `cd polished_feather_de_92723`
...
2. Clone this repo and `cd polished_feather_de_92723`
